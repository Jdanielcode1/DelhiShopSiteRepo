...
export const animalProductGroups: AnimalProductGroup[] = [
  {
    ...
    includesCustomFeeds: true,
    categories: [
      { id: "feed", titleEn: "Feed & Treats", titleEs: "Alimento y Premios", items: ["Poultry Feed", "Organic Feed", "Chick Starter Supplies", "Egg Layer Supplies", "Show Animal Feed", "Poultry Treats", "Mealworms & Grubs", "Oyster Shell", "Limestone & Calcium Supplements"] },
