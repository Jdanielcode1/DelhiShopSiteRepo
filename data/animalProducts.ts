...
export const animalProductGroups: AnimalProductGroup[] = [
    ...
    categories: [
      ...
      },
      {
        ...
        itemDetails: {
          ...
          "Delhi Super Egg": {
            description:
              "A high-protein feed formulated with 20.8% crude protein, setting it apart from conventional 16% layer feeds. Its ingredient blend includes soybean meal, cracked corn, whole wheat, grain sorghum, rice bran, and other grain-based ingredients. Oyster shell flour and ground limestone provide supplemental calcium sources, while added amino acids, vitamins, minerals, and fermentation products round out the nutritional profile.",
  ...
  },
  {
    ...
    categories: [
      ...
      { id: "health", titleEn: "Health, Hoof Care & Supplements", titleEs: "Salud, Cascos y Suplementos", items: ["Hoof Care Products", "Hoof Conditioners & Dressings", "Hoof Treatments", "Liniments & Muscle Care", "First Aid Supplies", "Calming Supplements", "Mineral & Salt Blocks", "Horse Dewormers", "Deworming Pastes", "Vitamins & Minerals", "Electrolytes", "Joint Supplements"] },
      { id: "stable", titleEn: "Tack & Stable Supplies", titleEs: "Equipo y Suministros de Establo", items: ["Halters & Lead Ropes", "Leg Wraps", "Hoof Picks", "Feed Scoops & Buckets", "Feeders & Waterers", "Bedding & Shavings"] },
      { id: "fly-control", titleEn: "Fly Control", titleEs: "Control de Moscas", items: ["Pyranha Animal Health", "Fly Spray", "Fly Masks", "Fly Repellents", "Fly-Control Products", "Livestock Fly Control"] },
    ],
  },
  {
    id: "cattle",
    ...
    categories: [
      ...
      { id: "pest-control", titleEn: "Barn Pest Control", titleEs: "Control de Plagas del Establo", items: ["Prozap", "Country Vet", "Martin’s Products", "Insecticides", "Fly Control", "Barn Pest Control"] },
      {
        ...
        items: [
          ...
          "Energy Supplements",
          "Poultry Conditioning Supplements",
